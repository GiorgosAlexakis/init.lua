...
vim.keymap.set('n', '<D-w>', '<C-w>', { noremap = true, silent = true })

vim.api.nvim_set_keymap('', '<D-g>', '<C-g>', { noremap = true, silent = true })
-- Map <C-s> and <D-s> to :w (save)
vim.api.nvim_set_keymap('n', '<C-s>', ':w<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<D-s>', ':w<CR>', { noremap = true, silent = true })

-- Map <C-q> and <D-q> to :q (quit)
vim.api.nvim_set_keymap('n', '<C-q>', ':wqa<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<D-q>', ':wqa<CR>', { noremap = true, silent = true })

-- Disable 's' in normal mode to prevent replacing characters
